...
| s1-leaf3 | 36 | 26 | 6 | 4 | 0 | Hardware, Interfaces | System |
...
| s1-brdr1 | System | VerifyCPUUtilization | Verifies whether the CPU utilization is below 75%. | - | failure | Device has reported a high CPU utilization -  Expected: < 75% Actual: 98.3% |
...
| s1-brdr1 | System | VerifyMemoryUtilization | Verifies whether the memory utilization is below 75%. | - | failure | Device has reported a high memory usage - Expected: < 75% Actual: 88.80% |
...
| s1-brdr2 | System | VerifyCPUUtilization | Verifies whether the CPU utilization is below 75%. | - | failure | Device has reported a high CPU utilization -  Expected: < 75% Actual: 98.6% |
...
| s1-brdr2 | System | VerifyMemoryUtilization | Verifies whether the memory utilization is below 75%. | - | failure | Device has reported a high memory usage - Expected: < 75% Actual: 88.82% |
...
| s1-leaf1 | System | VerifyCPUUtilization | Verifies whether the CPU utilization is below 75%. | - | failure | Device has reported a high CPU utilization -  Expected: < 75% Actual: 98.2% |
...
| s1-leaf2 | System | VerifyCPUUtilization | Verifies whether the CPU utilization is below 75%. | - | failure | Device has reported a high CPU utilization -  Expected: < 75% Actual: 97.7% |
...
| s1-leaf2 | System | VerifyMemoryUtilization | Verifies whether the memory utilization is below 75%. | - | failure | Device has reported a high memory usage - Expected: < 75% Actual: 88.94% |
...
| s1-leaf3 | System | VerifyCPUUtilization | Verifies whether the CPU utilization is below 75%. | - | failure | Device has reported a high CPU utilization -  Expected: < 75% Actual: 97.7% |
...
| s1-leaf3 | System | VerifyMemoryUtilization | Verifies whether the memory utilization is below 75%. | - | failure | Device has reported a high memory usage - Expected: < 75% Actual: 88.80% |
...
| s1-leaf4 | System | VerifyCPUUtilization | Verifies whether the CPU utilization is below 75%. | - | failure | Device has reported a high CPU utilization -  Expected: < 75% Actual: 98.5% |
...
| s1-leaf4 | System | VerifyMemoryUtilization | Verifies whether the memory utilization is below 75%. | - | failure | Device has reported a high memory usage - Expected: < 75% Actual: 88.94% |
...
| s1-spine1 | System | VerifyCPUUtilization | Verifies whether the CPU utilization is below 75%. | - | failure | Device has reported a high CPU utilization -  Expected: < 75% Actual: 98.0% |
...
| s1-spine1 | System | VerifyMemoryUtilization | Verifies whether the memory utilization is below 75%. | - | failure | Device has reported a high memory usage - Expected: < 75% Actual: 88.80% |
...
| s1-spine2 | System | VerifyCPUUtilization | Verifies whether the CPU utilization is below 75%. | - | failure | Device has reported a high CPU utilization -  Expected: < 75% Actual: 98.2% |
...
| s1-spine2 | System | VerifyMemoryUtilization | Verifies whether the memory utilization is below 75%. | - | failure | Device has reported a high memory usage - Expected: < 75% Actual: 88.79% |
